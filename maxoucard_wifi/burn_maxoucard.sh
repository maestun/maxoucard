...
then
	...
	echo "Usage: ./burn_maxoucard <SOFT_AP_NAME> <SOFT_AP_PASS> <AUTOCONNECT_PASS>"
else
	...
	rm -rf $BUILD_PATH
	mkdir $BUILD_PATH
	$ARDUINO_PATH/arduino-builder -dump-prefs -logger=machine -hardware $ARDUINO_PATH/hardware \
